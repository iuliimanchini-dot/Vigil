...
from cortex_forensic.language_profiles import get_profile_for_extension
from cortex_map_builder.source_adapters import get_adapter_for_file
import logging
...
def _extract_python_functions(content: str) -> list[FunctionInfo]:
    try:
        from cortex_forensic.gate_checks.common import extract_python_functions as _ast_extract
