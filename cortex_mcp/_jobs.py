...
``filelock.FileLock`` — exactly the pattern cortex_map_builder uses in
...
# On-disk layout (mirrors cortex_map_builder's <project>/.cortex/maps/).
...
# ---------------------------------------------------------------------------
# Atomic JSON write (mirrors cortex_map_builder.map_storage._atomic_write_json)
# ---------------------------------------------------------------------------
